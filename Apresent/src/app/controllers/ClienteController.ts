...
class ClienteController{
    ...
    async find(req: Request, res: Response){
        ...
        const j = await repository.findOne({where : {cpf}});
    ...
    async store(req: Request, res: Response){
        ...
        const cpf = req.body.cpf;//extrai os atributos nickname do corpo da mensagem.
    ...
    async update(req: Request, res: Response){
        ...
        async delete(req: Request, res: Response){
            ...
            const cpf = req.params.cpf;//extrai os atributos nickname e endereco do corpo da mensagem.
